...
//----------Functions called by the device itself (_device_)
//data index
...
public:
  ...
  void Start(float rho0, float Jx0, float Jy0); //Asignar valores iniciales a los campos rho y J
  void Collision(void);
...
//Cantidades Macroscópicas: Campos rho y J

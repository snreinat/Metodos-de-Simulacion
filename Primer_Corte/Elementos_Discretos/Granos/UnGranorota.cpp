...
//---- clase cuerpo ---
class Cuerpo{
  //se incluyen las variables para el desplazamiento y la rotación
private:
...
void Cuerpo::Inicie(double x0,double y0,double Vx0,double Vy0,
  ...
  theta=theta0; omega=omega0; I=2.0/5*m*R*R; //se considera el momento de inercia de una esfera
} 
